...
export default function Layout({ children, currentPageName }) {
  ...
  useEffect(() => {
    const checkAuthAndRedirect = async () => {
      try {
        ...
        const isPublicLandingPage = normalizedPath === '/solar' || normalizedPath === '/roofing' || normalizedPath === '/insurance' || normalizedPath === '/realestate' || normalizedPath === '/dream100' || normalizedPath === '/ecommerce' || normalizedPath === '/join';
  ...
  const isEarlyPublicPage = earlyPublicPath === '/solar' || earlyPublicPath === '/roofing' || earlyPublicPath === '/insurance' || earlyPublicPath === '/realestate' || earlyPublicPath === '/dream100' || earlyPublicPath === '/ecommerce' || earlyPublicPath === '/join';
