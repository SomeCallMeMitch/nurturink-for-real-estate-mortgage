        ...
        <div className="flex justify-around items-center h-16">
          <Link 
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${
              isActive('MobileHome') ? 'text-blue-600' : 'text-gray-500'
            }`}
          >
          ...
          <Link 
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${
              isActive('MobileClients') ? 'text-blue-600' : 'text-gray-500'
            }`}
          >
          ...
          <Link 
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${
              isActive('MobileSend') ? 'text-blue-600' : 'text-gray-500'
            }`}
          >
          ...
          <Link 
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${
              isActive('MobileProfile') ? 'text-blue-600' : 'text-gray-500'
            }`}
          >
