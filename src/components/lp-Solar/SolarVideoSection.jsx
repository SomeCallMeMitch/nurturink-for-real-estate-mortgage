 ...
 * bg #172840, 2-col: bullets left / video right
 * Mobile (<960px): single col, video moves above (order -1)
 */
const bullets = [
...
export default function SolarVideoSection() {
  return (
    <section style={{ background: '#172840', padding: '72px 40px' }}>
      <div className="solar-video-inner" style={{ maxWidth: '1060px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 480px', gap: '56px', alignItems: 'center' }}>
        ...
        {/* Right — video */}
        <div className="solar-video-right">
          <div style={{
      ...
      <style>{`
        @media (max-width: 960px) {
          .solar-video-inner { grid-template-columns: 1fr !important; }
          .solar-video-right { order: -1; }
        }
