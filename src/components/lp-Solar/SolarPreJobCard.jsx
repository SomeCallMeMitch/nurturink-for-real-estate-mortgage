...
/**
 * SolarPreJobCard — SECTION 5 wide card below three-card grid
 * Spec: "The Move Nobody Else Makes" pre-job card
 */
export default function SolarPreJobCard() {
  return (
    <div
      style={{
    ...
    >
      <div className="solar-prejob-inner" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0 }}>
        {/* Left */}
        <div className="solar-prejob-left" style={{ padding: '36px 40px', borderRight: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .solar-prejob-inner { grid-template-columns: 1fr !important; }
          .solar-prejob-left { border-right: none !important; border-bottom: 1px solid rgba(255,255,255,0.08) !important; }
        }
      `}</style>
    </div>
  );
