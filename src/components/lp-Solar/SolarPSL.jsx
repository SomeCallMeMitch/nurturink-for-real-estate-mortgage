...
/**
 * SolarPSL — SECTION 6: PSL FORMULA
 * bg #213659, 3-col grid P/S/L cards + sample note block
 */
const cards = [
...
export default function SolarPSL() {
  return (
    <section style={{ background: '#213659', padding: '80px 40px' }}>
      <div style={{ maxWidth: '1060px', margin: '0 auto' }}>
        ...
        <div className="solar-psl-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '20px', marginTop: '40px' }}>
          {cards.map((c, i) => (
            <div key={i} style={{
      ...
      <style>{`
        @media (max-width: 768px) {
          .solar-psl-grid { grid-template-columns: 1fr !important; }
