...
/**
 * RoofingCalculator — SECTION 8: ROI CALCULATOR
 * Cloned from SolarCalculator (corrected version with radius slider)
 */
    ...
    <section id="calculator" style={{ background: '#1a2d4a', padding: '80px 40px' }}>
      <div style={{ maxWidth: '1060px', margin: '0 auto' }}>
        ...
        <div className="roofing-calc-box" style={{
          ...
          <div className="roofing-calc-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '56px' }}>
            {/* Left — sliders */}
            <div>
      ...
      <style>{`
        @media (max-width: 768px) {
          .roofing-calc-grid { grid-template-columns: 1fr !important; gap: 36px !important; }
          .roofing-calc-box { padding: 24px 18px !important; }
