...
/**
 * RoofingScience — SECTION 7: SCIENCE / RESEARCH
 * Cloned from SolarScience
 */
const cards = [
  {
...
export default function RoofingScience() {
  return (
    <section style={{ background: '#f2f1ee', padding: '80px 40px' }}>
      <div style={{ maxWidth: '1060px', margin: '0 auto' }}>
        ...
        <div className="roofing-sci-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '22px', marginTop: '40px' }}>
          {cards.map((c, i) => (
            <div key={i} style={{
      ...
      <style>{`
        @media (max-width: 768px) {
          .roofing-sci-grid { grid-template-columns: 1fr !important; }
