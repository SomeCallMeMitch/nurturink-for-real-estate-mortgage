...
/**
 * Personal Credit Purchase Receipt Email Template
 * Sent when a user purchases credits for their personal account
 */
...
export default function PersonalCreditPurchaseReceiptEmail({
  user_firstName,
  user_email,
  order_number,
  transaction_id,
                ...
                <tr>
                  <td style={{ padding: '40px' }}>
                    <p style={{
                      ...
                      Thanks for your purchase, {user_firstName}!
                    </p>
                ...
                <tr>
                  <td style={{
                    ...
                    <p style={{
                      ...
                      This receipt was sent to {user_email}
                    </p>
                  </td>
                </tr>
              </table>
...
// Plain text version
export const personalCreditPurchaseReceiptPlainText = ({
  user_firstName,
  user_email,
  order_number,
  transaction_id,
