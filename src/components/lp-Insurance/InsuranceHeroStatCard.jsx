...
/**
 * InsuranceHeroStatCard — individual stat card in the hero 2×2 grid
 * Cloned from RoofingHeroStatCard
 */
export default function InsuranceHeroStatCard({ value, label }) {
  return (
    <div
      style={{
