...
/**
 * InsuranceThreeWays — SECTION 5: THREE WAYS + PRE-JOB CARD
 * Cloned from RoofingThreeWays
 */
const ways = [
  ...
  return (
    <section style={{ background: '#ffffff', padding: '80px 40px' }}>
      <div style={{ maxWidth: '1060px', margin: '0 auto' }}>
        ...
        <div className="insurance-ways-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '22px', marginTop: '40px' }}>
