...
/**
 * REPreJobCard — SECTION 5 wide card below three-card grid
 * Cloned from InsurancePreJobCard for Real Estate LP
 */
...
export default function REPreJobCard() {
  return (
    <div
      style={{
    ...
    >
      <div className="re-prejob-inner" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0 }}>
        {/* Left */}
        <div className="re-prejob-left" style={{ padding: '36px 40px', borderRight: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .re-prejob-inner { grid-template-columns: 1fr !important; }
          .re-prejob-left { border-right: none !important; border-bottom: 1px solid rgba(255,255,255,0.08) !important; }
        }
      `}</style>
    </div>
  );
