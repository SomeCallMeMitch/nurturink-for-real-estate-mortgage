...
/**
 * REPSL — SECTION 6: BEYOND THE CORE THREE
 * Cloned from InsurancePSL for Real Estate LP
 */
const cards = [
  ...
  return (
    <section style={{ background: '#213659', padding: '80px 40px' }}>
      <div style={{ maxWidth: '1060px', margin: '0 auto' }}>
        ...
        <div className="re-psl-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '20px', marginTop: '40px' }}>
          {cards.map((c, i) => (
            <div key={i} style={{
