...
const cards = [
  ...
  { label: 'Life Events', title: 'Social Media Scanning for Life Moments', body: "Amanda Furman of the Amanda Furman Real Estate Collective requires every team member to write five handwritten notes per week — none of them about real estate. She scans social media for three triggers: pain, pleasure, and celebration. A new job. A graduation. A new baby. A lost pet. No logo. No pitch. Just acknowledgment that she noticed. The result: 98% of her business comes from referrals. \"Nine point nine out of ten times, whoever I send a card to reaches back out to let me know how much it meant to them.\" (Source: BizBox Outside the Box Podcast, June 2025)" },
];
