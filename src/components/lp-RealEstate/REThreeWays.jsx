...
import REPreJobCard from './REPreJobCard';

/**
 * REThreeWays — SECTION 5: THREE WAYS
 * Cloned from InsuranceThreeWays for Real Estate LP
 */
const ways = [
  ...
  return (
    <section style={{ background: '#ffffff', padding: '80px 40px' }}>
      <div style={{ maxWidth: '1060px', margin: '0 auto' }}>
        ...
        <div className="re-ways-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '22px', marginTop: '40px' }}>
