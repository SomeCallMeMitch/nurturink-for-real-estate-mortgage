...
Deno.serve(async (req) => {
  try {
    ...
    const result = await resend.emails.send({
      ...
      to: user.email,
      subject: 'Test Email from NurturInk',
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body style="font-family: Arial, sans-serif; padding: 40px; background-color: #f9fafb;">
            <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 40px; border-radius: 8px;">
              ...
              <p style="font-size: 16px; color: #374151; line-height: 1.6;">
                This is a test email from NurturInk. If you're receiving this, your Resend integration is working correctly!
              </p>
