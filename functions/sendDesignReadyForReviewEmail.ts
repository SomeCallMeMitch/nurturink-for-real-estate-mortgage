          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 30px 40px; border-top: 1px solid #e5e7eb; text-align: center;">
              ...
              <p style="color: #9ca3af; font-size: 12px; line-height: 1.6; margin: 0 0 8px 0;">
                Questions? Email us at <a href="mailto:design@roofscribe.com" style="color: #FF7A00; text-decoration: none;">design@roofscribe.com</a>
              </p>
...
RoofScribe - Your Custom Design is Ready!
...
Questions? Email us at design@roofscribe.com
© 2024 RoofScribe. All rights reserved.
`;
...
Deno.serve(async (req) => {
  try {
    ...
    const result = await resend.emails.send({
      from: 'RoofScribe <design@roofscribe.com>',
      to: data.user_email,
