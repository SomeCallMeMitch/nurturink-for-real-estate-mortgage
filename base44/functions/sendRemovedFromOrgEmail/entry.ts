                ...
                <tr>
                  <td style="padding: 20px;">
                    ...
                    <ul style="margin: 0; padding: 0 0 0 20px; color: #1e40af; font-size: 14px; line-height: 1.8;">
                      ...
                      <li>Your personal NurturInk account remains active</li>
...
NurturInk - Organization Membership Update
...
- Your personal NurturInk account remains active
...
Deno.serve(async (req) => {
  try {
    ...
    const result = await resend.emails.send({
      ...
      to: data.user_email,
      subject: `You've been removed from ${data.org_name} on NurturInk`,
